...
### SIFT feature###
# load data
X <- read.csv("../data/train/SIFT_train.csv", header = FALSE)[,-1]
...
### SIFT + PCA feature###
# load data
X <- read.csv("../data/train/SIFT_pca.csv")[,-1]
y <- read.csv("../data/train/label_train.csv")[,3]
y <- as.factor(y)
index <- sample(1:nrow(X), 0.75*nrow(X), replace=FALSE)
X.train <- X[index,]
...
### HOG feature###
# load data
X <- read.csv("../data/train/hog_feature.csv")[,-1]
y <- read.csv("../data/train/label_train.csv")[,3]
y <- as.factor(y)
index <- sample(1:nrow(X), 0.75*nrow(X), replace=FALSE)
X.train <- X[index,]
...
### GRAY feature###
# load data
X <- read.csv("../data/train/gray_features.csv")[,-(1:2)]
y <- read.csv("../data/train/label_train.csv")[,3]
y <- as.factor(y)
index <- sample(1:nrow(X), 0.75*nrow(X), replace=FALSE)
X.train <- X[index,]
